...
" A parameter is the variable that is listed inside the parethesis in the function definition.
" An argument is the value that are sent to the function when it is called . "

# 2. In your own words, describe what each of the following errors means.
# Write your response using complete sentences.
# syntax error = "a syntax error is when you don't put print first " .
# type error = " A type error is when your typing something but you type it wrong and it alerts you  
# name error = " A name error is when you name a new file but you didn't put the right name so it let's you know that ".


# 3. What function would I use if I wanted to convert an integer data type into 
# a string data type? you woulduse str ()


# 4. What function would I use if I wanted to change a float data type into a 
# an integer data type? you would use an array .
...
#symbols
# = eqivalent , it tells u two things are equal to eachother .
# == 
# =!
...
" the 3 i chose is change , certain speed , gears . I chose those 3 because onceyour monitoring the speed if u see they pass the  
" speed limit then u tell them to change gears and slowdown ."
...
" the 3 clues is the day of the week, the time of day , and meal plan , the reason i chose them is because if you know what time and day it is "
" then you will know which meal your supposed to be eating ."
...
# Please provide three (3) clues/ keywords and explain why you chose them to get full credit.
" the 3 clues is 85% grade , passing the sat , grade ,I chose these because if you know the student has above an 85 % then you know "
" theypassed the class and has honors but if they don't then they didn't ."
...
# Please provide three (3) clues/ keywords and explain why you chose them to get full credit.
" 60 degrees , 80 degrees ,and 50 degrees , the reason ichose those is because if we know that 50 is cold and 80 is hot then we know that60 is balanced ."
