...
# to print out data to a user? Print ()

#2. What built-in function would you use if you wanted 
# a user to pass in data to a program? Input ()
...
#4. What does it mean when you encounter a syntax error?mistakes in the source code, such as spelling and punctuation errors, incorrect labels, and so on, which cause an error message to be generated by the compiler

#5. What is a variable? Provide an example of a variable in code.symbolic representations of any numbers

#6. Write a function in Python that when called will print out 
# your name. Print function ()

#7. What is a function definition and a function call?Defining it names the function and specifies what to do when the function is called. Calling the function actually performs the specified actions with the indicated parameters.
